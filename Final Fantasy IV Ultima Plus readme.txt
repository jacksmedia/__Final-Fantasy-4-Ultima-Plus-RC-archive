...
---------------------------------------------------------
-= Complete hack v2024 Plus =-

For a NON-headered file, apply...
'Final Fantasy IV - Ultima v2024 Plus - no header.ips'
directly to a non-headered 'Final Fantasy II (U) (V1.1).sfc';

For a headered file, please download TUSH @
 https://neoromhacking.net/utilitypage.php?id=608
And then:
- Open TUSH
- Open your ROM with TUSH
- The program will confirm that your ROM is headered
- Click the "Remove Header" button,
close TUSH, and follow the process outlined above.
---------------------------------------------------------
...
Special thanks:
---------------------------------------------------------
I would first like to give a big THANK YOU to the entire FF4Ultima team:
chillyfeez, Ace_Aileron, mathguy86, Couch_23, Smbai, JDP, scarlet, Lily, verdelet, Caterplus07, edgeworth, DarkZitan, Retrohacknerd, and CasualTom.

I would also like to give credits to everyone that's contributed to this project:
Pinkpuff, FlamePurge, Fauntleroy, Yousei, Grimoire LD, b0ardface, SnowPin, and Crow!
...
Nicoc1991 - Alternate battle & map sprites plus portraits for several characters
Tsushiy - Alternate Rosa and Golbez battle sprites (and portraits, for Golbez)
...
select per character in Main Menu as usual, or in battle with Row command
...
------------------------
- New Amano-inspired portraits by mrBrawndo (2)
- New portraits by xJ4cks (26)
- New portraits by Nicoc1991 (2)


Alternate Map Sprites
---------------------
- New color options for menu sprites by xJ4cks (9)
- New color options for menu sprites by Nicoc1991 (2)


Comprehensive Style Packs = font + map sprites + portraits + battle sprites
---------------------------------------------------------------------------
- All 4 of the above options curated across 7 different Style Packs options for "FF4 Ultima Plus" (by xJ4cks)

Optional patches from earlier versions of "FF4 Ultima" were retained (see below) and categorized alongside the new content in this release, for ease of use.
...
---------------------------------------------------------
Saves from v2022(rev19 through 25, 25a, 25b, 25c) will work perfectly without any issues.

Saves from versions 2022(rev14 through 18) will work fine without any issues except:
...
Saves from all versions before 2022 will absolutely GLITCH. Please start a new game and enjoy! :)
---------------------------------------------------------
